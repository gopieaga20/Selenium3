...
public class BaseClass {
		...
		public String writeData(String sheetName, int rowNo, int cellNo, String orderNo) throws IOException {
			String data= null;
			File file = new File("C:\\Users\\Jega\\eclipse-workspace\\FbTask1\\ExcelData\\FacebookTask.xlsx");
